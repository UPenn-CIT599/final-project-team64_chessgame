...
public class GUI_Chess_Pieces {
    ...
    public GUI_Chess_Pieces() {

    }

    static GUI_Chess_Pieces[] WhiteTeam = new GUI_Chess_Pieces[16];
    static GUI_Chess_Pieces[] BlackTeam = new GUI_Chess_Pieces[16];
//    GUI_Chess_Pieces[] GUI_CP_Black_Team = new GUI_Chess_Pieces[16];
    ...
    public static void main(String[] args) {
        for (GUI_Chess_Pieces e : WhiteTeam) {
            System.out.println(e);
        }
        for (GUI_Chess_Pieces e : BlackTeam) {
            System.out.println(e);
        }
